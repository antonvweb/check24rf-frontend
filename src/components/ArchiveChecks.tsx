...
import {ArchiveItem} from "@/components/archiveChecks/ArchiveItem";
...
export const ArchiveChecks = () => {
    const group1 = items.slice(0, 3);
    const group2 = items.slice(3, 7);
    const group3 = items.slice(7, 10);

    return (
        <div className={styles.archiveChecks}>
            ...
            <main className={styles.mainArchiveChecks}>
                <div className={styles.listArchiveMonth}>
                    <section className={styles.month}>
                        <span className={styles.titleMonth}>Архив за август</span>
                        <div className={styles.archives}>
                            <ArchiveItem id={1} count={items.length} date={"12.01.24"} checks={items} />
                            <ArchiveItem id={1} count={group1.length} date={"12.01.24"} checks={group1} />
                            <ArchiveItem id={1} count={group1.length} date={"12.01.24"} checks={group1} />
                            <ArchiveItem id={1} count={group1.length} date={"12.01.24"} checks={group1} />
                        </div>
                    </section>
                    <section className={styles.month}>
                        <span className={styles.titleMonth}>Архив за сентябрь</span>
                        <div className={styles.archives}>
                            <ArchiveItem id={2} count={group2.length} date={"12.02.24"} checks={group2} />
                            <ArchiveItem id={2} count={group2.length} date={"12.02.24"} checks={group2} />
                            <ArchiveItem id={2} count={group2.length} date={"12.02.24"} checks={group2} />
                            <ArchiveItem id={2} count={group2.length} date={"12.02.24"} checks={group2} />
                            <ArchiveItem id={2} count={group2.length} date={"12.02.24"} checks={group2} />
                    ...
                    <section className={styles.month}>
                        <span className={styles.titleMonth}>Архив за октябрь</span>
                        <div className={styles.archives}>
                            <ArchiveItem id={3} count={group3.length} date={"12.03.24"} checks={group3} />
                            <ArchiveItem id={3} count={group3.length} date={"12.03.24"} checks={group3} />
                            <ArchiveItem id={3} count={group3.length} date={"12.03.24"} checks={group3} />
                            <ArchiveItem id={3} count={group3.length} date={"12.03.24"} checks={group3} />
                            <ArchiveItem id={3} count={group3.length} date={"12.03.24"} checks={group3} />
