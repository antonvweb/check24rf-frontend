...
interface ErrorCodeSuccessProps {
    isCodeValid: boolean;
}

export const ErrorCodeSuccess = ({isCodeValid} :ErrorCodeSuccessProps) => {
    return(!isCodeValid && (
        <div className={styles.errorWrapper}>
            ...
            >
                <g filter="url(#filter0_d_328_1593)">
                    <path d="M4 6C4 2.68629 6.68629 0 10 0H206C209.314 0 212 2.68629 212 6V13.6754C212 16.258 213.7 18.4972 215.898 19.8534C216.711 20.355 217.525 20.9531 218.2 21.6409C219.23 22.6896 219.312 24.326 218.446 25.5134C217.709 26.5239 216.765 27.3535 215.827 28.0123C213.714 29.497 212 31.742 212 34.3246V41C212 44.3137 209.314 47 206 47H10C6.68629 47 4 44.3137 4 41V6Z" fill="#F0F3F6"/>
                </g>
                <defs>
                    <filter id="filter0_d_328_1593" x="0" y="0" width="223.039" height="55" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                        ...
                        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_328_1593"/>
                        <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_328_1593" result="shape"/>
                    </filter>
                </defs>
            </svg>
            ...
            <div className={styles.errorContent}>
                ...
                <span className={styles.errorText}>Код не верный</span>
            </div>
        </div>
    ))
}